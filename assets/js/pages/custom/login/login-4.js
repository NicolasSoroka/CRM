...
var KTLogin = function() {
	...
	var _handleFormSignin = function() {
		...
		FormValidation
		    ...
		    .on('core.form.valid', function() {
				...
				KTUtil.btnWait(formSubmitButton, _buttonSpinnerClasses, "Iniciando...");
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					text: "Parece que hubo un error, intente nuevamente",
					icon: "error",
					buttonsStyling: false,
	...
	var _handleFormForgot = function() {
		...
		FormValidation
		    ...
		    .on('core.form.valid', function() {
				// Show loading state on button
				KTUtil.btnWait(formSubmitButton, _buttonSpinnerClasses, "Aguarde un instante");
				...
				fields: {
					...
					email: {
						validators: {
							...
							emailAddress: {
								message: 'El correo ingresado no parece ser valido'
							}
						}
					}
				},
