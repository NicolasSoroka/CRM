						...
						<ul class="menu-subnav">
							...
							<li class="menu-item" aria-haspopup="true">
								<a href="custom/apps/inbox.html" class="menu-link">
									...
									<span class="menu-text">Asignados</span> <span class="menu-label"> <span class="label label-primary label-inline">Reasignar / Editar</span></span>
								</a>
							</li>
							<li class="menu-item" aria-haspopup="true">
								<a href="custom/apps/inbox.html" class="menu-link">
									...
									<span class="menu-text">Disponibles</span> <span class="menu-label"> <span class="label label-primary label-inline">Asignar / Editar</span></span>
								</a>
							</li>
						</ul>
					</div>
