					...
					<tr id="<?= $banner['id'] ?>">
						<td class="text-center align-middle">
							<div class="form-group mb-1">
								<textarea class="form-control" id="textArea_<?= $banner['id'] ?>" rows="3"><?= $banner['caracteristica'] ?></textarea>
							</div>
						</td>
						<td class="text-center align-middle">
						...
						<!-- Guardar -->
						<td class=" text-center align-middle">
								<button style="border: none; background-color: transparent;" onclick="saveItem(<?= $banner['id'] ?>)">
						...
						<!-- Eliminar -->
						<td class="text-center align-middle">
							<button style="border: none; background-color: transparent;" onclick="deleteItem(<?= $banner['id'] ?>)">
		...
		<script>
			...
			function saveItem(id) {
				$.ajax({
					...
					data: {
						item_id: id,
						banner_text: $('#textArea_' + id).val(),
						function: 'save_banner_text'
					},
					success: function(response) {
						location.reload();
					}
